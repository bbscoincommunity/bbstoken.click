...
//          mywallet = window.tronWeb.defaultAddress.base58;
          ...
          if (mywallet == false) { document.getElementById("tronit").innerHTML = "&#128274; Seems like Tronlink may still be locked, please unlock it to be able to login."; }
            ...
            document.getElementById("tronit").innerHTML = "<!-- i class='fa fa-at'>:</i --> <!-- b> Address:</b><hr --><i class='text-dark text-monospace pb-3 h7' data-toggle='tooltip' data-placement='top' title='" + mywallet + "'><!-- text-nowrap --><b><i class='fas fa-wallet'></i> " + mywallet + "</b></i><br><i class='text-dark text-monospace pb-3 h7' data-toggle='tooltip' data-placement='top' title='" + DAppWallet + "'><!-- text-nowrap --><b><i class='fas fa-return'></i> " + DAppWallet + "</b></i><br>&nbsp;<br><!-- b><i class='fa fa-coins'></i>Tokens:</b><hr -->";
